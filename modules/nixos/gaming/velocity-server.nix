...
in
{
  ...
  services.minecraft-servers = {
    ...
    servers.velocity = {
      ...
      # Velocity config generated by sops-nix template at activation time
      # (embeds the decrypted forwarding secret).
      symlinks."velocity.toml" = config.sops.templates."velocity.toml".path;
    };
  };
